function y = movewindow2(nmat,tmin,tmax,wlength,wstep,timetype,varargin)
...
%© Part of the MIDI Toolbox, Copyright © 2003, University of Jyväskylä, Finland
% See License.txt
	...
	y= [];
		for t = tmin:wstep:tmax
			x = onsetwindow(nmat,t-wlength,t,timetype); 			for f=1:length(varargin)
				if isempty(x) % Return NaN for empty matrix
					z=NaN;
				else
